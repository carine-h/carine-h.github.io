...
hist(pv_change$d_marg_change, 
     main = "Overall County-Level Change in Democratic Vote Share Maring: 2016-2020")
abline(v = mean(pv_change$d_marg_change, na.rm = TRUE), col = 'red', lwd = 2)
...
plot_usmap(data = dat, regions = "counties", values = "d_marg_change", 
           include = states, 
           exclude = "New York") +
...
plot_usmap(data = dat, regions = "counties", values = "D_pv2p", 
           include = states, 
           exclude = "New York") +
  scale_fill_gradient2(
    high = "blue", 
