...
png("~/Desktop/R studio/carine-h.github.io/images/10_castro_wc.png", width=800, height=400)
...
png("~/Desktop/R studio/carine-h.github.io/images/10_castro_plot.png", width=800, height=400)
...
png("~/Desktop/R studio/carine-h.github.io/images/10_socialist_wc.png", width=800, height=400)
...
png("~/Desktop/R studio/carine-h.github.io/images/10_socialist_plot.png", width=800, height=400)
...
png("~/Desktop/R studio/carine-h.github.io/images/10_border_wc.png", width=800, height=400)
...
png("~/Desktop/R studio/carine-h.github.io/images/10_border_plot.png", width=800, height=400)
...
ggplot(state_sums, aes(x = state, y = log_ad)) + 
...
ggsave("~/Desktop/R studio/carine-h.github.io/images/10_TV_spending.png", height = 5, width = 10)
```
